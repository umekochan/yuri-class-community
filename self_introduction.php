    ...
    <div class="container">
        ...
        <main class="main">
            <div class="mainTitle">
                ...
                <p class="main__profile">プロフィール：<br>
                    <form class="mainTitle__textrareaForm" method="post" action="sample.cgi">
                    <textarea class="mainTitle__textrarea"  id="" name="otoiawase" rows="15" cols="50" required>ここに自分の自己紹介を簡単に書いてください。例えば、自分の趣味、SNSのアカウントなど
＊このページはあなたのクラスページの中にあるクラスメンバーという項目に投稿されます。
＊このページを投稿することによって学校内で新たなコミュニティを作ることができます。
                    </textarea>
                    </form>
                </p>
                <div class="listMenu__buttonLayout4">
                    <button type="submit" class="listMenu__button listMenu__button--class"><i class="fa-solid fa-plus"></i><a href="" class="">クラスページに投稿</a></button>
                </div>
                <div class="listMenu__buttonLayout5">
                    <button type="submit" class="listMenu__button"><a href="" class="">戻る</button>
                    <div class="mainBackButton"></div>
                </div>
            </div>
        </main>
</body>
