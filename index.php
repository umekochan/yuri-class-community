...
<?php include "parts/header.php"; ?>
    <main class="main">
        ...
        <div class="login-form">
            ...
            <input name="password" type="password" id="password" class="login-formPassword" rows="100" placeholder="パスワードを入力"></input>
            <input name="email" type="text" id="email" class="login-formSchoolId" rows="100" placeholder="メールアドレスを入力"></input>
