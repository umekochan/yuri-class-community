...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/find students.css">
        ...
        <div class="mainMenu">
            ...
            <div class="listMenu__item">
                ...
                <div class="listMenu__buttonLayout">
                    <button type="button" class="listMenu__button"><a href="" class=""><i class="fa-solid fa-magnifying-glass"></i>探す</a></input>
                </div>
                <div class="listMenu__buttonLayout2">
                    <button type="button" class="listMenu__button listMenu__button--classStudent"><i class="fas fa-user"></i><a href="" class="">生徒を探す</a></input>
                </div>
            </div>
            <div class="listMenu__item">
