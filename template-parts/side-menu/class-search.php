        ...
        <div class="mainMenu">
            ...
            <div class="listMenu__item">
                ...
                <div class="listMenu__buttonLayout">
                    <button type="button" class="listMenu__button"><a href="" class=""><i class="fa-solid fa-magnifying-glass"></i>探す</a></button>
                </div>
                <div class="listMenu__buttonLayout2">
                    <button type="button" class="listMenu__button listMenu__button--classStudent"><i class="fas fa-user"></i><a href="" class="">生徒を探す</a></button>
                </div>
            </div>
            <div class="listMenu__item">
